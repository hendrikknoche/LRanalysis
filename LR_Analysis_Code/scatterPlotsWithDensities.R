...
grid.arrange(arrangeGrob(p2, legend, p1, p3, widths=unit.c(unit(0.15, "npc"), unit(0.25, "npc")), heights=unit.c(unit(0.25, "npc"), unit(0.75, "npc")), nrow=2))
