...
file_list <- list.files(path="D:/Dropbox/Medialogy/Work with Hendrik/GitHub_DATA/LRanalysis/data/TargetSizeTestDataOutsetCenterGoal/Data/Without T", pattern="*.csv", full.names=T, recursive=FALSE)
